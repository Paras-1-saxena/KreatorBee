...
class BlockedThirdPartyDomains(models.TransientModel):
    _name = "website.custom_unblocked_third_party_domains"
    _description = "User list of blocked 3rd-party domains"

    content = fields.Text(default=lambda s: s.env['website'].get_current_website().custom_unblocked_third_party_domains)
    ...
    def action_save(self):
        ...
        self.env['website'].get_current_website().custom_unblocked_third_party_domains = '\n'.join(domains)
